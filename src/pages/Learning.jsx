  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        try {
          const progressResponse = await learningAPI.getProgress();
          setUserProgress(progressResponse?.data || progressResponse);
        } catch {
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-green-100">
              Expand your agricultural knowledge with expert-curated content designed for modern farming
            </p>
          </div>
        ...
        >
          <div className="container mx-auto max-w-7xl text-center">
            ...
            <p className="mb-6 text-gray-600">
              Join thousands of farmers learning from agriculture experts worldwide
            </p>
